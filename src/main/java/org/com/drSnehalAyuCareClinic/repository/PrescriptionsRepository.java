...
/**
 * Repository class for <code>Prescriptions</code> domain objects All method names are compliant with Spring Data naming
 * conventions so this interface can easily be extended for Spring Data See here: http://static.springsource.org/spring-data/jpa/docs/current/reference/html/jpa.repositories.html#jpa.query-methods.query-creation
 *
 * @author Sonal Wankhede
 */
@Profile("spring-data-jpa")
public interface PrescriptionsRepository extends Repository<Prescription, Integer> {

    /**
     * Save a <code>Prescriptions</code> to the data store, either inserting or updating it.
     *
     * @param prescription the <code>Prescriptions</code> to save

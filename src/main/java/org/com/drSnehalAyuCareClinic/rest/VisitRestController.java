...
public class VisitRestController {
	...
	public ResponseEntity<Visit> updateVisit(@PathVariable("visitId") int visitId, @RequestBody @Valid Visit visit, BindingResult bindingResult){
		...
		currentVisit.setTemperature(visit.getTemperature());
		currentVisit.setPulse(visit.getPulse());
		currentVisit.setSpo2(visit.getSpo2());
		currentVisit.setRespirationRate(visit.getRespirationRate());
		currentVisit.setBloodPressure(visit.getBloodPressure());
		currentVisit.setHeight(visit.getHeight());
